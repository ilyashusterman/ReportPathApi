...
class LiveReportParser(object):
    ...
    def parse_live_report(cls, live_report):
        ...
        live_report = cls.set_report_default_times(live_report)
        ...
        live_report.report_text = cls.parse_report_text(live_report)
        live_report.location = cls.parse_location(live_report)
    ...
    @classmethod
    def set_report_default_times(cls, live_report):
    ...
    @classmethod
    def parse_location(cls, live_report):
