...
class TestLiveReportConverter(TestCase):
    ...
    def check_live_report_load(self):
        self.assertEqual(self.live_report.to_json_string()['sysid'], 'e347a32c-e0d7-45cc-98c1-6580033063e3')
        self.assertEqual(self.live_report.to_json_string()['creation_time'], '2017-10-08T21:18:59.313Z')
        self.assertEqual(self.live_report.to_json_string()['raw']['date_time'], '08_10_2017 21:18:42 UTC')
        self.assertEqual(self.live_report.to_json_string()['raw']['type'], 'waze_traffic_alerts_lv')
        self.assertEqual(self.live_report.to_json_string()['raw']['data']['subtype'], 'ACCIDENT_MINOR')
        self.assertEqual(self.live_report.to_json_string()['raw']['data']['reliability'], 7)
        self.assertEqual(self.live_report.to_json_string()['raw']['data']['pubMillis'], 1507496096059)
        self.assertEqual(self.live_report.to_json_string()['raw']['data']['street'], 'S Rainbow Blvd')
