...
DEFAULT_REPORT_SYSTEM_ID = 1234
DEFAULT_REPORT_RELIABILITY = 4
DEFAULT_REPORT_CONFIDENCE = 1
DEFAULT_REPORT_TYPE = 'undefined_type'
DEFAULT_REPORT_DESCRIPTION = ''
DEFAULT_REPORT_DATA_TYPE = 'undefined data type'
DEFAULT_REPORT_SUB_TYPE = 'undefined_subtype'
REPORT_DEFAULT_X = 1
REPORT_DEFAULT_Y = 1
REPORT_DEFAULT_STREET = 'no_selected_street'
